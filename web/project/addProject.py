    ...
    async def post(self):
        ...
        try:
            ...
            if role != 'branchManager':
                ...
                if description is None or not description or isinstance(description, str):
                    code = 4135
                ...
                if projectCode is None or not projectCode or isinstance(projectCode, str):
                    code = 4134
                ...
                if projectType is None or not projectType or isinstance(projectType, str):
                    code = 4133
                ...
                if projectCategory is None or not projectCategory or isinstance(projectCategory, str):
                ...
                if endDate is None or not endDate or isinstance(endDate, str):
                    code = 4124
