...
class OnBoardingHandler(tornado.web.RequestHandler, MongoMixin):
    ...
    async def post(self):
        ...
        try:
            ...
            if role != 'HR-1' and role != 'HR-2' and role != 'HR-3' and role != 'branchManager':
                code = 4001
                ...
                if phone is None or not phone or isinstance(message, str) or len(phone) != 10:
                    code = 4138
                    message = 'Please enter valid phone'
                    raise Exception
                phone = phone.strip()
                ...
                if address is None or not address or isinstance(message, str):
